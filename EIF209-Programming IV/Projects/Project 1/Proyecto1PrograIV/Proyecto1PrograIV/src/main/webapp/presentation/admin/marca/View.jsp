<%-- 
    Document   : View
    Created on : 18 abr. 2023, 16:51:37
    Author     : Nicole
--%>
...
<html>
    ...
    <body>
        ...
        <div>
            <form method="post" action="presentation/admin/marca/addMarca">
                <div>Descripcion de la marca: </div>
...
<%!
    ...
    private Map<String,String[]> getForm(Model model){
       ...
       values.put("descripcionFld", new String[]{model.getCurrent().getMarca()});
       return values;
    } 
%> 