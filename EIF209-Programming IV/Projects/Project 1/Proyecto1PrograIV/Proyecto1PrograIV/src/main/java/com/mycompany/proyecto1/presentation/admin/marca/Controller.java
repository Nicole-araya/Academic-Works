 ...
 * @author Nicole
 */
@WebServlet(name = "ControllerMarca", urlPatterns = {"/presentation/admin/marca/addBlank","/presentation/admin/marca/addMarca"})
public class Controller extends HttpServlet {
        ...
        switch (request.getServletPath()) {
          case "/presentation/admin/marca/addBlank":
              viewUrl = this.addShow(request);
              break;
              case "/presentation/admin/marca/addMarca":
    ...
    private String addShow(HttpServletRequest request) {
        return addShowAction(request);
    }

    private String addShowAction(HttpServletRequest request) {
    ...
    private String addAction(HttpServletRequest request) {
       ...
       Service service = Service.instance();
        ...
        try { 
           ...
           service.agregarMarca(model.getCurrent());
    ...
    private void updateModel(HttpServletRequest request) {
      Model model= (Model) request.getAttribute("model");
      model.getCurrent().setMarca(request.getParameter("descripcionFld"));
    }
