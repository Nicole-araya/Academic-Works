 ...
 * @author Nicole
 */
@WebServlet(name = "ClienteDatosController", urlPatterns = {"/presentation/cliente/datos/show","/presentation/cliente/datos/update"}) //ACTUALIZACION DE DATOS :B hacer modificaciones en service ahroita jejeje uwu
  ...
  protected void processRequest(HttpServletRequest request, 
    ...
    public String showAction(HttpServletRequest request) {
        ...
        try {        
            ...
            return "/presentation/cliente/datos/View.jsp";  //VIEW
    ...
    public String updateAction(HttpServletRequest request) {
        ...
        HttpSession session = request.getSession(true);
        Usuario usuario = (Usuario) session.getAttribute("usuario");
        model.getCurrent().setUser(usuario);
    ...
    Map<String,String> validar(HttpServletRequest request){
        ...
        if (request.getParameter("medioFld").isEmpty()){ 
            errores.put("medioFld","Metodo de Pago requerido");
        }
        return errores;
    }
    ...
    void updateModel(HttpServletRequest request){
       Model model = (Model) request.getAttribute("model");
        ...
        model.getCurrent().setMedioPago( request.getParameter("medioFld"));
   }
