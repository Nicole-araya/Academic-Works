...
public class TableModel extends AbstractTableModel implements javax.swing.table.TableModel {
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (cols[col]){
            case CODIGO: return sucursal.getID();
            case REFERANCIA: return sucursal.getReferencia();
    ...
    public static final int REFERANCIA=1;
    public static final int DIRECCION=2;
    public static final int ZONAJE=3;

    String[] colNames = new String[5];
    private void initColNames(){
        colNames[CODIGO]= "Cedula";
        colNames[ REFERANCIA]= "Referencia";
