...
public class View implements Observer {
    ...
    private JTextField agregarField;
    ...
    int row; //para seleccionar el receiver
    public View() {
        ...
        registraseButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        agregar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                String id=agregarField.getText();
        ...
        buscarButton.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                controller.buscarContacto(buscarField.getText());
            }
        });
    }
    ...
    public void update(java.util.Observable updatedModel, Object properties) {
            ...
            int[] cols = {TableModel.CONTACTOS};
            contactos.setModel(new TableModel(cols, model.getContactos()));
